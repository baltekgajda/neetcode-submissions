class Solution {
    fun trap(height: IntArray): Int {
        // best solution better than this one is to keep array of minleft and minRight for each height
        // for each height we check what is minimum of value at this index in minleft and minRight arrays
        // and after we subtract if from current height we get water at this position
